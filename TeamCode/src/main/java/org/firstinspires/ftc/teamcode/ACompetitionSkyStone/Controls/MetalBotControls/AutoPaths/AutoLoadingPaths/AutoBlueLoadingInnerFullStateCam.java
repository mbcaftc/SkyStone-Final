...
import org.firstinspires.ftc.teamcode.EasyOpenCV.SkystoneLocation;

@Autonomous(name = "Blue:Loading:Inner:Full:STATE:EOCV_CAM!")
@Disabled
public class AutoBlueLoadingInnerFullStateCam extends AutoLoading {

    public MetalBot Bot = new MetalBot();
    public EOCVWebCam Cam = new EOCVWebCam();

    SkystoneLocation skyLocation = null;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Skystone ", Cam.skyLoc);
            telemetry.update();
