...
public class VuforiaWebcam {
    ...
    public static final VuforiaLocalizer.CameraDirection CAMERA_CHOICE = BACK;  //default BACK
    public static final boolean PHONE_IS_PORTRAIT = false  ; // was FALSE
    ...
    public void initCamera(HardwareMap hwMap) {
        ...
        stoneTarget.setLocation(OpenGLMatrix
                ...
                .multiplied(Orientation.getRotationMatrix(EXTRINSIC, XYZ, DEGREES, 90, 0, -90)));  //firstAngle was 90  // thirdAgnle was -90
