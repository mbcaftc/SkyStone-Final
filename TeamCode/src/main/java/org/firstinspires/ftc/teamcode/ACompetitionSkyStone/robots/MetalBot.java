...
//    public Servo capstoneDropper = null;
    ...
    public final double TOLERANCE = 0;
    ...
    public Servo AutoGrabberClaw;
    public Servo AutoGrabberArm;
    ...
    public CRServo clawExtender = null;
    public Servo clawExtender2 = null;
    public Servo clawGrabber = null;

    //CAPSTONE DEPLOYER (jduval)
    public Servo capstoneDeployer = null;
  ...
  //  Vuforia Constructors, Variables and Constants
    ...
    public void initRobot (HardwareMap hwMap, String Mode) {
        ...
        //stuff for auto arm grabber stone grabber thing yes
        AutoGrabberClaw = hwBot.get(Servo.class,"stone_grabber");
        AutoGrabberArm = hwBot.get(Servo.class,"auto_arm");
        ...
        */
        ...
        capstoneDeployer = hwBot.get(Servo.class, "capstone_deploy");
        capstoneDeployer.setDirection(Servo.Direction.FORWARD);

        tapeMeasure = hwBot.get(CRServo.class, "tape_measure");
...
// ******   Intake Control Mechanisms
    ...
    public void intakeSpinInward () {           // Used in TeleOp
        ...
        intakeLSpinner.setPower(-0.85); //also -.85, slow -.55
        intakeRSpinner.setPower(-0.85); //fast -.85, slow .-55
    }

    public void intakeSpinInwardAutoSlow () {       // Used in Auto
        intakeLSpinner.setPower(-.55);      // was .7
        intakeRSpinner.setPower(-.55);      // was .7 ~  worked  sometimes but did not spin... maybe not enough torque?
    }

    public void intakeSpinInwardAutoFast () {
        intakeLSpinner.setPower(-.85);
        intakeRSpinner.setPower(-.85);
    }
    ...
    public void intakePushIn () {
        intakePusher.setPosition(0.57);               // values came from servo testing
    }

    public void intakePushNeutral () {
        intakePusher.setPosition(0.057);                // values came from servo testing
    }

    public void intakePushHalf () {
        intakePusher.setPosition(0.24);
    }
    ...
    public void intakeDeployLower () {
        ...
        intakeDeploy.setPosition(.753);

    }
    public void intakeDeployRaise () {

        intakeDeploy.setPosition(.381);
    }

    // ***** Auto Arm Grabber and arm and thing for auto arm

    public void AutoClawGrab() {
        AutoGrabberClaw.setPosition(0.9);
    }
    public void AutoClawRelease() {
        AutoGrabberClaw.setPosition(0.6);
    }
                                                    //need to be set and tested!!!!
    public void AutoArmDown() {
        AutoGrabberArm.setPosition(0.035);
    }
    public void AutoArmNorm() {
        AutoGrabberArm.setPosition(0.4);
    }
    ...
    public void stackingArmUp() {                    // This is physically down
        ...
        stackingLiftLeft.setPower(0.65);            // 25% power to minimize unspooling
        stackingLiftRight.setPower(0.65);
    }
 ...
 /*   public void stackingArmUpEncoders () {
    ...
    {
        clawExtender2.setPosition(.676);
    }
    public void clawExtenderRetract2 () {
        clawExtender2.setPosition(.066);
    }

    public void clawExtenderAutoIntake2 () {
        clawExtender2.setPosition(.275);
    }
    ...
    // CAPSTONE DEPLOY CONTROLS
    public void capStoneChill () {
        capstoneDeployer.setPosition(.69);
    }

    public void capStoneDeploy () {
        capstoneDeployer.setPosition(.3669);
    }


    // TAPE MEASURE CONTROLS.

    public void tapeMeasureMove (double power) {
    ...
    public void led_control (RevBlinkinLedDriver.BlinkinPattern led_color) {
        pattern = led_color;
        blinkinLedDriver.setPattern(pattern);
    }
    ...
    public void driveGyro (int encoders, double power) throws InterruptedException {
        ...
        while (frontLeftMotor.getCurrentPosition() < encoders + startPosition && linearOp.opModeIsActive()) {
